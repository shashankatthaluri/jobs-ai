...
export default function SignupPage() {
    ...
    const handleGoogleSignup = async () => {
        const { error } = await supabase.auth.signInWithOAuth({
            provider: 'google',
            options: {
                redirectTo: `${window.location.origin}/auth/callback?redirect=/upload`,
            },
        })
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-stone">
                        Start crafting resumes that speak their language
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                            />
                            <p className="mt-1 text-xs text-stone">Minimum 6 characters</p>
                        </div>
